...
#define __HAL_RCC_USART3_CLK_ENABLE() (RCC->APB1ENR1 |= RCC_APB1ENR1_USART3EN)
...
#define __HAL_RCC_TIM2_CLK_ENABLE() (RCC->APB1ENR1 |= RCC_APB1ENR1_TIM2EN)
...
// I2C clocks
#define __HAL_RCC_I2C1_CLK_ENABLE() (RCC->APB1ENR1 |= RCC_APB1ENR1_I2C1_I3C1EN)
...
// SBS clocks
#define __HAL_RCC_SBS_CLK_ENABLE()       (RCC->APB4ENR |= RCC_APB4ENR_SBSEN)

// XSPI clocks
#define __HAL_RCC_XSPI1_CLK_ENABLE()     (RCC->AHB5ENR |= RCC_AHB5ENR_XSPI1EN)
#define __HAL_RCC_XSPI2_CLK_ENABLE()     (RCC->AHB5ENR |= RCC_AHB5ENR_XSPI2EN)
#define __HAL_RCC_XSPIM_CLK_ENABLE()     (RCC->AHB5ENR |= RCC_AHB5ENR_XSPIMEN)
